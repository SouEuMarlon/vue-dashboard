...
// Dados mockados caso a API esteja fora do ar
const mockProducts = [
  {
    id: 1,
  ...
  actions: {
    ...
    async fetchProducts() {
      ...
      try {
        ...
        console.warn('API indisponível, usando dados mockados:', err)
        this.products = mockProducts
        this.error = null // Limpa o erro já que temos dados mockados
      } finally {
